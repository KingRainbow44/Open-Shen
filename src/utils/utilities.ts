...
/**
 * Wrap the given object into a promise.
 * @param object The object to wrap.
 * @param error The result if an exception occurs.
 */
export function promiseWrap(object: any, error: any = undefined): Promise<any> {
